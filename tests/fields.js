...
QUnit.test('GenericIPAddressField', 58, function() {
  ...
  cleanErrorEqual(f, 'This is not a valid IPv6 address.', '12345:2:3:4')
  cleanErrorEqual(f, 'This is not a valid IPv6 address.', '1::2:3::4')
  cleanErrorEqual(f, 'This is not a valid IPv6 address.', 'foo::223:6cff:fe8a:2e8a')
  cleanErrorEqual(f, 'This is not a valid IPv6 address.', '1::2:3:4:5:6:7:8')
  cleanErrorEqual(f, 'This is not a valid IPv6 address.', '1:2')
