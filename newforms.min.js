...
typeof w?o.withMode(w,f,e[g],r,d(g,k)):f(e[g],r,d(g,k)),null===i)continue}else i=e[g];h(i)||(i=[i]);m.push(this.createElement(a,r,i,w))}return m},fragment:function(){var a=function(){var a;a=1===arguments.length&&h(arguments[0])?arguments[0]:B.call(arguments);return this.mode?(f.flatten(a),this.modes[this.mode].fragment(a)):i(["#document-fragment"].concat(a))};a.map=function(a,b){if(!m.Function(b))return o.fragment(a);for(var c=[],f=0,t=a.length,g;f<t;f++)g=b(a[f],d(f,t)),null!==g&&(c=c.concat(g));
...
g=0,i=b.length;g<i;g++)e[""+(f?b.charAt(g):b[g])]=!0;for(var f=[],o=d.iterate(this.choices).concat(a||[]),g=0,i=o.length;g<i;g++)if(h.Array(o[g][1])){for(var J=[],j=o[g][1],t=0,w=j.length;t<w;t++)J.push("\n"),J.push(this.renderOption(e,j[t][0],j[t][1]));f.push("\n");J.push("\n");f.push(c.createElement("optgroup",{label:o[g][0]},J))}else f.push("\n"),f.push(this.renderOption(e,o[g][0],o[g][1]));return f};z.prototype.renderOption=function(a,b,e){var b=""+b,d={value:b};"undefined"!=typeof a[b]&&(d.selected=
...
a);k.call(this,a);null!==a.inputFormats&&(this.inputFormats=a.inputFormats)}});e.prototype.toJavaScript=function(a){c.Date(a)||(a=m.strip(a));if(c.String(a))for(var b=0,e=this.inputFormats.length;b<e;b++)try{return this.strpdate(a,this.inputFormats[b])}catch(d){}throw f(this.errorMessages.invalid);};e.prototype.strpdate=function(a,b){return g.strpdate(a,b)};var x=e.extend({constructor:function(a){if(!(this instanceof k))return new x(a);e.call(this,a)},widget:b.DateInput,inputFormats:m.DEFAULT_DATE_INPUT_FORMATS});
x.prototype.defaultErrorMessages=i.extend({},x.prototype.defaultErrorMessages,{invalid:"Enter a valid date."});x.prototype.toJavaScript=function(a){return s(a)?null:a instanceof Date?new Date(a.getFullYear(),a.getMonth(),a.getDate()):e.prototype.toJavaScript.call(this,a)};var w=e.extend({constructor:function(a){if(!(this instanceof k))return new w(a);e.call(this,a)},widget:b.TimeInput,inputFormats:m.DEFAULT_TIME_INPUT_FORMATS});w.prototype.defaultErrorMessages=i.extend({},w.prototype.defaultErrorMessages,
...
{Field:k,CharField:n,IntegerField:o,FloatField:t,DecimalField:u,BaseTemporalField:e,DateField:x,TimeField:w,DateTimeField:K,RegexField:F,EmailField:z,FileField:r,ImageField:A,URLField:D,BooleanField:R,NullBooleanField:L,ChoiceField:C,TypedChoiceField:I,MultipleChoiceField:H,TypedMultipleChoiceField:N,FilePathField:G,ComboField:E,MultiValueField:y,SplitDateTimeField:O,IPAddressField:P,GenericIPAddressField:M,SlugField:Q}});v.define("./forms",function(q,l,a){function c(a){var b=[],c;for(c in a)j.hasOwn(a,
...
!1:!this.errors().isPopulated()};a.prototype.addPrefix=function(a){return null!==this.prefix?g("{prefix}-{fieldName}",{prefix:this.prefix,fieldName:a}):a};a.prototype.addInitialPrefix=function(a){return g("initial-{fieldName}",{fieldName:this.addPrefix(a)})};a.prototype._htmlOutput=function(a,b,c,d){for(var f=this.nonFieldErrors(),g=[],i=[],o=null,j=null,o=this.hiddenFields(),t=this.visibleFields(),k,l=0,m=o.length;l<m;l++){k=o[l];j=k.errors();if(j.isPopulated())for(var u=0,n=j.errors.length;u<n;u++)f.errors.push("(Hidden field "+
k.name+") "+j.errors[u]);i.push(k.defaultRendering())}l=0;for(m=t.length;l<m;l++){k=t[l];o="";(j=k.cssClasses())&&(o=j);var s=null,p=null,q=null,v=null,j=k.errors();if(j.isPopulated()){s=new this.errorConstructor;u=0;for(n=j.errors.length;u<n;u++)s.errors.push(j.errors[u]);!0===c&&(g.push(b(s.defaultRendering())),s=null)}k.label&&(p=k.labelTag()||"");k.field.helpText&&(q=k.field.helpText);l==m-1&&0<i.length&&(v=i);null!==s&&(s=s.defaultRendering());g.push(a(p,k.defaultRendering(),q,s,o,v))}f.isPopulated()&&
(v=null,0<i.length&&0==g.length&&(v=i),g.splice(0,0,b(f.defaultRendering(),v)));0<i.length&&0==g.length&&g.push(b("",i,this.hiddenFieldRowCssClass));return!0===d||"dom"==h.mode?g:h.html.markSafe(g.join("\n"))};a.prototype.asTable=function(){var a=function(a,b,c,e,d,f){var g=[];e&&g.push(e);g.push(b);c&&(g.push(h.createElement("br")),g.push(c));f&&(g=g.concat(f));b={};d&&(b["class"]=d);return h.createElement("tr",b,[h.createElement("th",{},[a]),h.createElement("td",{},g)])},b=function(a,b,c){a=[a];
...
s=d.IntegerField,v=d.BooleanField,p=j.HiddenInput,k=function(){var a={};a.TOTAL_FORMS=s({widget:p});a.INITIAL_FORMS=s({widget:p});a.MAX_NUM_FORMS=s({required:!1,widget:p});return m.Form.extend(a)}(),n=l.extend({constructor:function(a){a=h.extend({data:null,files:null,autoId:"id_{name}",prefix:null,initial:null,errorConstructor:b,managementFormCssClass:null},a);this.isBound=null!==a.data||null!==a.files;this.prefix=a.prefix||n.getDefaultPrefix();this.autoId=a.autoId;this.data=a.data||{};this.files=
...
this.initialFormCount(),a.MAX_NUM_FORMS=this.maxNum,a=new k({autoId:this.autoId,prefix:this.prefix,initial:a});null!==this.managementFormCssClass&&(a.hiddenFieldRowCssClass=this.managementFormCssClass);return a};n.prototype.initialForms=function(){return this.forms.slice(0,this.initialFormCount())};n.prototype.extraForms=function(){return this.forms.slice(this.initialFormCount())};n.prototype.emptyForm=function(a){var b={autoId:this.autoId,prefix:this.addPrefix("__prefix__"),emptyPermitted:!0},a=
new this.form(h.extend(b,a));this.addFields(a,null);return a};n.prototype.cleanedData=function(){if(!this.isValid())throw Error(this.constructor.name+" object has no attribute 'cleanedData'");for(var a=[],b=0,c=this.forms.length;b<c;b++)a.push(this.forms[b].cleanedData);return a};n.prototype.deletedForms=function(){if(!this.isValid()||!this.canDelete)throw Error(this.constructor.name+" object has no attribute 'deletedForms'");if("undefined"==typeof this._deletedFormIndexes){this._deletedFormIndexes=
[];for(var a=this.totalFormCount(),b=0;b<a;b++){var c=this.forms[b];(!(b>=this.initialFormCount())||c.hasChanged())&&this._shouldDeleteForm(c)&&this._deletedFormIndexes.push(b)}}a=[];b=0;for(c=this._deletedFormIndexes.length;b<c;b++)a.push(this.forms[this._deletedFormIndexes[b]]);return a};n.prototype.orderedForms=function(){if(!this.isValid()||!this.canOrder)throw Error(this.constructor.name+" object has no attribute 'orderedForms'");if("undefined"==typeof this._ordering){this._ordering=[];for(var a=
this.totalFormCount(),b=0;b<a;b++){var c=this.forms[b];if(!(b>=this.initialFormCount())||c.hasChanged())(!this.canDelete||!this._shouldDeleteForm(c))&&this._ordering.push([b,c.cleanedData.ORDER])}this._ordering.sort(function(a,b){return null===a[1]&&null===b[1]?a[0]-b[0]:null===a[1]?1:null===b[1]?-1:a[1]-b[1]})}a=[];b=0;for(c=this._ordering.length;b<c;b++)a.push(this.forms[this._ordering[b][0]]);return a};n.prototype.errors=function(){null===this._errors&&this.fullClean();return this._errors};n.prototype.toString=
function(){return""+this.defaultRendering()};n.prototype.defaultRendering=function(){return this.asTable()};n.prototype.totalFormCount=function(){if(this.isBound)return this.managementForm().cleanedData.TOTAL_FORMS;var a=this.initialFormCount(),b=this.initialFormCount()+this.extra;null!==this.maxNum&&(a>this.maxNum&&0<=this.maxNum)&&(b=a);null!==this.maxNum&&(b>this.maxNum&&0<=this.maxNum)&&(b=this.maxNum);return b};n.prototype.initialFormCount=function(){if(this.isBound)return this.managementForm().cleanedData.INITIAL_FORMS;
var a=null!==this.initial&&0<this.initial.length?this.initial.length:0;null!==this.maxNum&&(a>this.maxNum&&0<=this.maxNum)&&(a=this.maxNum);return a};n.prototype._constructForms=function(){this.forms=[];for(var a=this.totalFormCount(),b=0;b<a;b++)this.forms.push(this._constructForm(b))};n.prototype._constructForm=function(a,b){var c={autoId:this.autoId,prefix:this.addPrefix(a)};this.isBound&&(c.data=this.data,c.files=this.files);null!==this.initial&&0<this.initial.length&&"undefined"!=typeof this.initial[a]&&
...
MAX_NUM_FORM_COUNT:"MAX_NUM_FORMS",ORDERING_FIELD_NAME:"ORDER",DELETION_FIELD_NAME:"DELETE",ManagementForm:k,BaseFormSet:n,formsetFactory:function(a,b){var b=h.extend({formset:n,extra:1,canOrder:!1,canDelete:!1,maxNum:null},b),c=b.formset,d=b.extra,f=b.canOrder,g=b.canDelete,i=b.maxNum;delete b.formset;delete b.extra;delete b.canOrder;delete b.canDelete;delete b.maxNum;b.constructor=function(b){this.form=a;this.extra=d;this.canOrder=f;this.canDelete=g;this.maxNum=i;c.call(this,b)};return c.extend(b)},
