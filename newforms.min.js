...
n=p?function(a,b){jQuery(a).html(b)}:function(a,b){try{a.innerHTML=b}catch(g){var c=document.createElement("div");for(c.innerHTML=b;a.firstChild;)a.removeChild(a.firstChild);for(;c.firstChild;)a.appendChild(c.firstChild)}},h={version:"2.1.0",mode:null,modes:{},addMode:function(b){b=a.extend({isModeObject:function(){return!1},api:{},apply:{}},b);this.modes[b.name]=b;this[b.name]=a.extend(f(b.name),b.apply);null===this.mode&&(this.mode=b.name)},withMode:function(a,b){var g=this.mode;this.mode=a;try{return b.apply(null,
