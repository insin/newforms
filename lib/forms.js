 ...
 * @return input data for the field, may be null if there was no input.
 */
BaseForm.prototype.getData = function(name) {
  if (!object.hasOwn(this.fields, name)) {
  ...
  return field.widget.valueFromData(this.data, this.files, this.addPrefix(name))
}
