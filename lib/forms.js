...
var formProps = {
  autoId: function(props, propName, componentName, location) {
...
var RenderForm = React.createClass({
  ...
  getFormOptions: function() {
    var formPropNames = Object.keys(formProps)
    var options = object.extend({}, this.props)
    for (var i = 0, l = formPropNames.length, prop = formPropNames[i]; i < l ; i++) {
