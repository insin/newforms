...
var nodeListType = /^\[object (?:RadioNodeList|NodeList|HTMLCollection)\]$/
...
function fieldData(form, field) {
  ...
  // Check if we've got a list of elements
  if (nodeListType.test(Object.prototype.toString.call(element))) {
